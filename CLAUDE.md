...
### 后端 (Rust)
- **Tauri 2** - 桌面应用框架
- **tauri-plugin-opener 2** - 文件资源管理器集成
- **tauri-plugin-dialog 2** - 原生文件/目录选择对话框
- **tokio 1** - 异步运行时
...
- **@tauri-apps/plugin-dialog 2** - 前端原生对话框 API
...
├── tailwind.config.js          # Tailwind CSS 配置（darkMode: class）
